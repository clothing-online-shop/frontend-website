...
function Carousel({
  ...
  React.useEffect(() => {
    if (!api) return
    // Đồng bộ canScrollPrev/canScrollNext ban đầu từ embla api (nguồn external) — deferred
    // qua microtask để không setState đồng bộ ngay trong thân effect (react-hooks/set-state-in-effect).
